...
linker.cmd: package/cfg/empty_pem3.xdl
	$(SED) 's"^\"\(package/cfg/empty_pem3cfg.cmd\)\"$""\"F:/University of Oulu/O_Alkeet_ja_Tietokonejarjestelmat/Tamagotchi/Tamagotchi_project/Debug/configPkg/\1\""' package/cfg/empty_pem3.xdl > $@
